...
Mineradio 是一款 Windows 桌面沉浸式音乐播放器，融合**网易云音乐、QQ音乐、汽水音乐**三大平台，把天气电台、搜索播放、歌词舞台、粒子视觉和 3D 歌单架组合成一个更接近现场感的私人音乐空间。
...
1.1.2 的核心目标是添加汽水音乐平台支持，实现三大音乐平台（网易云音乐、QQ音乐、汽水音乐）的统一体验，同时优化 DIY 按钮位置和用户界面。
...
> 安全提示：`v1.0.10` 及更早旧安装包不再建议继续安装或传播，请先隔离旧安装包。请使用本页提供的 `Mineradio-1.1.2-Setup.exe` 进行纯净安装。
